...
from browser_use_ultra.browser.events import BrowserConnectedEvent, BrowserStopEvent
...
class HarRecordingWatchdog(BaseWatchdog):
	...
	async def _write_har(self) -> None:
		...
		try:
			bu_version = importlib_metadata.version('browser-use-ultra')
		except Exception:
		...
		har_obj = {
			'log': {
				'version': '1.2',
				'creator': {'name': 'browser-use-ultra', 'version': bu_version},
