...
from browser_use_ultra.dom.views import (
	EnhancedDOMTreeNode,
	SerializedDOMState,
)
from browser_use_ultra.observability import observe_debug
from browser_use_ultra.utils import create_task_with_error_handling, time_execution_async

if TYPE_CHECKING:
	from browser_use_ultra.browser.views import BrowserStateSummary, NetworkRequest, PageInfo, PaginationButton
...
class DOMWatchdog(BaseWatchdog):
	...
	async def _get_pending_network_requests(self) -> list['NetworkRequest']:
		...
		"""
		from browser_use_ultra.browser.views import NetworkRequest
...
"""
	...
	async def on_BrowserStateRequestEvent(self, event: BrowserStateRequestEvent) -> 'BrowserStateSummary':
		...
		"""
		from browser_use_ultra.browser.views import BrowserStateSummary, PageInfo
	...
	def _detect_pagination_buttons(self, selector_map: dict[int, EnhancedDOMTreeNode]) -> list['PaginationButton']:
		...
		"""
		from browser_use_ultra.browser.views import PaginationButton
	...
	async def _get_page_info(self) -> 'PageInfo':
		...
		from browser_use_ultra.browser.views import PageInfo
