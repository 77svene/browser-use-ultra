...
_DEMO_PANEL_SCRIPT = r"""(function () {
  ...
  const EXCLUDE_ATTR = 'data-browser-use-ultra-exclude-' + SESSION_ID;
  const PANEL_ID = 'browser-use-ultra-demo-panel';
  const STYLE_ID = 'browser-use-ultra-demo-panel-style';
  ...
  const TOGGLE_BUTTON_ID = 'browser-use-ultra-demo-toggle';
  ...
  function initializePanel() {
    ...
    if (savedWidth) {
      document.documentElement.style.setProperty('--browser-use-ultra-demo-panel-width', `${savedWidth}px`);
    }
  ...
  function addStyles() {
    ...
    style.textContent = `
      #${PANEL_ID} {
        ...
        top: 0;
        right: 0;
        width: var(--browser-use-ultra-demo-panel-width, 340px);
      ...
      #${PANEL_ID} .browser-use-ultra-demo-header {
      ...
      #${PANEL_ID} .browser-use-ultra-demo-header h1 {
        font-size: 15px;
      ...
      #${PANEL_ID} .browser-use-ultra-badge {
        font-size: 11px;
        padding: 2px 10px;
        border-radius: 999px;
      ...
      #${PANEL_ID} .browser-use-ultra-logo img {
        height: 36px;
      }

      #${PANEL_ID} .browser-use-ultra-header-actions {
        margin-left: auto;
        display: flex;
        align-items: center;
        gap: 8px;
      ...
      #${PANEL_ID} .browser-use-ultra-close-btn {
        width: 28px;
        height: 28px;
        border-radius: 50%;
      ...
      #${PANEL_ID} .browser-use-ultra-close-btn:hover {
        background: rgba(255, 255, 255, 0.15);
        border-color: rgba(255, 255, 255, 0.35);
      }

      #${PANEL_ID} .browser-use-ultra-demo-body {
        flex: 1;
        overflow-y: auto;
      ...
      #${PANEL_ID} .browser-use-ultra-demo-body::-webkit-scrollbar {
        width: 8px;
      }

      #${PANEL_ID} .browser-use-ultra-demo-body::-webkit-scrollbar-thumb {
        background: rgba(255, 255, 255, 0.25);
        border-radius: 999px;
      }

      .browser-use-ultra-demo-entry {
        display: flex;
        gap: 12px;
        padding: 10px 18px;
        border-left: 2px solid transparent;
        border-bottom: 1px solid rgba(255, 255, 255, 0.04);
        animation: browser-use-ultra-fade-in 0.25s ease;
        background: #000000;
      }

      .browser-use-ultra-demo-entry:last-child {
        border-bottom-color: transparent;
      }

      .browser-use-ultra-entry-icon {
        font-size: 16px;
        line-height: 1.2;
        width: 20px;
      }

      .browser-use-ultra-entry-content {
        flex: 1;
        min-width: 0;
      }

      .browser-use-ultra-entry-meta {
        font-size: 11px;
        letter-spacing: 0.08em;
        text-transform: uppercase;
        color: white;
      ...
      .browser-use-ultra-entry-message {
        margin: 0;
      ...
      .browser-use-ultra-markdown-content {
        margin: 0;
        line-height: 1.5;
      }

      .browser-use-ultra-markdown-content p {
        margin: 0 0 8px 0;
      }

      .browser-use-ultra-markdown-content p:last-child {
        margin-bottom: 0;
      }

      .browser-use-ultra-markdown-content h1,
      .browser-use-ultra-markdown-content h2,
      .browser-use-ultra-markdown-content h3 {
        margin: 8px 0 4px 0;
        font-weight: 600;
        color: #f8f9ff;
      }
      ...
      .browser-use-ultra-markdown-content code {
      ...
      .browser-use-ultra-markdown-content pre {
      ...
      .browser-use-ultra-markdown-content pre code {
      ...
      .browser-use-ultra-markdown-content ul,
      .browser-use-ultra-markdown-content ol {
        margin: 4px 0 4px 16px;
        padding: 0;
      }

      .browser-use-ultra-markdown-content li {
        margin: 2px 0;
      }

      .browser-use-ultra-markdown-content a {
        color: #60a5fa;
        text-decoration: underline;
      }

      .browser-use-ultra-markdown-content a:hover {
        color: #93c5fd;
      }

      .browser-use-ultra-markdown-content strong {
        font-weight: 600;
        color: #f8f9ff;
      }

      .browser-use-ultra-markdown-content em {
        font-style: italic;
      }

      .browser-use-ultra-demo-entry:not(.expanded) .browser-use-ultra-markdown-content {
        max-height: 120px;
        overflow: hidden;
        mask-image: linear-gradient(to bottom, rgba(0,0,0,1), rgba(0,0,0,0));
      }

      .browser-use-ultra-entry-toggle {
      ...
      .browser-use-ultra-demo-entry.level-info { border-left-color: #60a5fa; }
      .browser-use-ultra-demo-entry.level-action { border-left-color: #34d399; }
      .browser-use-ultra-demo-entry.level-thought { border-left-color: #f97316; }
      .browser-use-ultra-demo-entry.level-warning { border-left-color: #fbbf24; }
      .browser-use-ultra-demo-entry.level-success { border-left-color: #22c55e; }
      .browser-use-ultra-demo-entry.level-error { border-left-color: #f87171; }

      @keyframes browser-use-ultra-fade-in {
  ...
  function buildPanel() {
    ...
    header.className = 'browser-use-ultra-demo-header';
    const title = document.createElement('div');
    title.className = 'browser-use-ultra-logo';
    const logo = document.createElement('img');
    logo.src = 'https://raw.githubusercontent.com/browser-use-ultra/browser-use-ultra/main/static/browser-use-ultra-dark.png';
    logo.alt = 'Browser-use';
    logo.loading = 'lazy';
    title.appendChild(logo);
    const actions = document.createElement('div');
    actions.className = 'browser-use-ultra-header-actions';
    const closeBtn = document.createElement('button');
    closeBtn.type = 'button';
    closeBtn.className = 'browser-use-ultra-close-btn';
    ...
    body.className = 'browser-use-ultra-demo-body';
  ...
  function adjustLayout() {
    ...
    document.documentElement.style.setProperty('--browser-use-ultra-demo-panel-width', `${width}px`);
    if (state.isOpen) {
  ...
  function hydrateFromStoredMarkup() {
    ...
    try {
      ...
      if (html) {
        ...
        for (const entryNode of state.list.querySelectorAll('.browser-use-ultra-demo-entry')) {
          const toggle = entryNode.querySelector('.browser-use-ultra-entry-toggle');
          if (toggle) {
  ...
  function createEntryNode(entry) {
    ...
    row.className = `browser-use-ultra-demo-entry level-${entry.level}`;
    row.setAttribute('data-id', entry.id);

    const icon = document.createElement('span');
    icon.className = 'browser-use-ultra-entry-icon';
    icon.textContent = LEVEL_ICONS[entry.level] || LEVEL_ICONS.info;

    const content = document.createElement('div');
    content.className = 'browser-use-ultra-entry-content';

    const meta = document.createElement('div');
    meta.className = 'browser-use-ultra-entry-meta';
    const time = formatTime(entry.timestamp);
    const label = LEVEL_LABELS[entry.level] || entry.level;
    meta.innerHTML = `<span>${time}</span><span>${label}</span>`;

    const messageWrapper = document.createElement('div');
    messageWrapper.className = 'browser-use-ultra-entry-message';
    const messageText = entry.message.trim();
    const messageHtml = messageText;
    const message = document.createElement('div');
    message.className = 'browser-use-ultra-markdown-content';
    ...
    if (messageText.length > 160) {
      ...
      toggle.type = 'button';
      toggle.className = 'browser-use-ultra-entry-toggle';
  ...
  function applyPersistedExpansion(node) {
    ...
    try {
      ...
      if (id && expanded.has(id)) {
        ...
        const toggle = node.querySelector('.browser-use-ultra-entry-toggle');
        if (toggle) {
  ...
  window.addEventListener('browser-use-ultra-log', handleLogEvent);
})();
"""
...
(() => {{
	...
	const event = new CustomEvent('browser-use-ultra-log', {{ detail }});
