...
from browser_use_ultra.dom.views import NodeType, SimplifiedNode
from browser_use_ultra.llm.messages import ContentPartImageParam, ContentPartTextParam, ImageURL, SystemMessage, UserMessage
from browser_use_ultra.observability import observe_debug
from browser_use_ultra.utils import is_new_tab_page, sanitize_surrogates

if TYPE_CHECKING:
	from browser_use_ultra.agent.views import AgentStepInfo
...
class SystemPrompt:
	def __init__(
		...
		is_browser_use_ultra_model: bool = False,
		...
		self.is_browser_use_ultra_model = is_browser_use_ultra_model
	...
	def _load_prompt_template(self) -> None:
		...
		try:
			...
			if self.is_browser_use_ultra_model:
				if self.flash_mode:
					template_filename = 'system_prompt_browser_use_ultra_flash.md'
				elif self.use_thinking:
					template_filename = 'system_prompt_browser_use_ultra.md'
				else:
					template_filename = 'system_prompt_browser_use_ultra_no_thinking.md'
			...
			with (
				importlib.resources.files('browser_use_ultra.agent.system_prompts')
