...
from browser_use_ultra.agent.views import AgentHistoryList
from browser_use_ultra.browser.views import PLACEHOLDER_4PX_SCREENSHOT
...
def create_history_gif(
	...
	if show_logo:
		try:
			logo = Image.open('./static/browser-use-ultra.png')
