...
from browser_use_ultra.browser import BrowserSession
from browser_use_ultra.browser.profile import BrowserProfile
...
from browser_use_ultra.llm.messages import (
	AssistantMessage,
	BaseMessage,
...
from browser_use_ultra.tokens.views import UsageSummary
from browser_use_ultra.tools.service import CodeAgentTools, Tools
...
class CodeAgent:
	...
	def __init__(
		...
		**kwargs,
		...
		self.agent_directory = base_tmp / f'browser_use_ultra_code_agent_{self.id}_{timestamp}'
		...
		self.version = get_browser_use_ultra_version()
		try:
